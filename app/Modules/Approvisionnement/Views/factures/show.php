<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div class="flex-1">
            ...
            <p class="text-sm text-slate-500"><?= e($facture['fournisseur']) ?> — Commande <?= e($facture['numero_commande']) ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <div class="card card-body">
            ...
            <dl class="space-y-2 text-sm">
                ...
                <a href="<?= url('approvisionnement/factures/'.$facture['oid_doc'].'/imprimer') ?>" target="_blank" class="btn-secondary btn-sm">
            <i class="fa-solid fa-print"></i> Imprimer
        </a>
        <?php if((float)$facture['reste_a_payer']>0 && !empty($_SESSION['droits']['approvisionnement.regler'])): ?>
        <div class="card card-body">
            <h2 class="font-semibold text-slate-700 mb-3">Enregistrer un règlement</h2>
            <form method="POST" action="<?= url('approvisionnement/factures/'.$facture['oid_doc'].'/reglement') ?>">
                <?= csrfField() ?>
                <div class="mb-3">
    ...
    <div class="card overflow-hidden">
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="<?= url('approvisionnement/reglements/'.$r['id_reglement_f'].'/recu') ?>" target="_blank" class="text-violet-600 hover:text-violet-800 text-xs" title="Imprimer le reçu"><i class="fa-solid fa-receipt"></i></a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody></table>

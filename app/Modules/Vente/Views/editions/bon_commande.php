...
ob_start();
?>
<?php $titreDocument = 'Bon de Commande Client — ' . $cmd['numero']; ?>
<div class="btn-print">
...
<div class="page">
    ...
    <div class="titre-doc">Bon de Commande Client</div>
    <div class="numero-doc"><?= htmlspecialchars($cmd['numero']) ?></div>
    <div class="bloc-infos">
        <div>
            <h4>Client</h4>
            <p><strong><?= htmlspecialchars($cmd['client']) ?></strong></p>
        </div>
        <div>
            <h4>Commande</h4>
            ...
            <p><strong>Type :</strong> <?= $cmd['est_comptant'] ? 'Vente comptant' : 'À crédit' ?></p>
    ...
    <table class="tableau">
        <thead><tr>
            ...
            <th>Désignation</th>
            <th class="r" style="width:11%">Quantité</th>
    ...
    <div class="signatures">
        <div class="signature-box"><div class="ligne-sign"></div><p>Commercial / Vendeur</p></div>
        <div class="signature-box"><div class="ligne-sign"></div><p>Client</p></div>

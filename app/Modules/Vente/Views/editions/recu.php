...
<div class="page">
    <div class="entete">
        ...
        <div class="entete-info"><strong>Date :</strong> <?= (new DateTime())->format('d/m/Y') ?></div>
    </div>
    <div class="titre-doc">Reçu de Règlement Client</div>
    <div class="numero-doc">Règlement n° <?= $regl['id_reglement_c'] ?></div>
    ...
    <div style="text-align:center;margin:10mm 0;padding:8mm;border:2px solid #7c3aed;border-radius:8px;">
        <p style="font-size:12px;color:#64748b;margin-bottom:4mm;">Montant reçu</p>
